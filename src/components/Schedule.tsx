...
const Schedule = () => {
  ...
  const scheduleDay2: ScheduleItem[] = [
    ...
    {
      time: "04:00 p.m. – 04:20 p.m.",
      title: "Presentación de los jueces",
      icon: Users,
      description: "",
    },
    {
      time: "04:20 p.m. – 05:30 p.m.",
      title: "Revisión de videos y la evaluación",
      icon: Lightbulb,
      description: "",
    },
    {
      time: "05:30 p.m. – 05:45 p.m.",
      title: "Cálculo de resultados y selección de finalistas",
      icon: Users,
      description: "",
    },
    {
      time: "05:50 p.m. – 06:50 p.m.",
