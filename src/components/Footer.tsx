          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="bg-card border border-primary/30 rounded px-3 py-2 inline-block">
                ...
                <p className="text-sm font-mono text-primary font-bold">Young AI Leaders Bogotá</p>
              </div>
            </div>
          ...
          <div className="pt-8 border-t border-terminal-border">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-muted-foreground font-mono text-sm">
                <span className="text-primary">&copy;</span> 24h - Hackathon Colombia. Construyendo el futuro.
              </p>
